    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="px-6 py-10 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          {[
            ...
            <div key={action.title} className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
              ...
              <Link
                href={action.href}
                className="inline-block bg-[#185FA5] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#0C447C] transition-colors"
              >
                {action.btn}
              </Link>
            </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm text-center">
          ...
          <Link
            href="/leaderboard"
            className="inline-block mt-4 bg-[#E6F1FB] text-[#0C447C] px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#B5D4F4] transition-colors"
          >
            View Leaderboard
          </Link>
        </div>
