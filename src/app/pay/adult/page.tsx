...
export default function PayAdultPage() {
  return (
      ...
      <div className="max-w-md w-full">
        ...
        <div className="rounded-2xl p-8 mb-4"
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="text-xl font-bold text-white mt-3 mb-1">Adult Session</h2>
            <p className="text-sm" style={{ color: "#A0A3B1" }}>Pay for your court session</p>
          </div>
          ...
          <div className="rounded-xl p-5 mb-6 text-center"
            ...
            <p className="text-xs mt-1" style={{ color: "#A0A3B1" }}>per session · adult</p>
          </div>

          <div className="flex flex-col gap-2 mb-6 text-sm" style={{ color: "#A0A3B1" }}>
            {["Access to all courts during session", "Equipment available on request", "Coached sessions available separately"].map((item) => (
