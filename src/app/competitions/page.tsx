...
const competitions = [
  ...
  },
  {
    ...
    format: "Singles U14",
    description: "A fun and competitive tournament for junior players under 14. All abilities welcome — great experience for young players.",
    location: "Braidhurst High School Sports Hall, Motherwell",
  ...
  },
  {
    ...
    description: "A relaxed mixed doubles competition — great for social players. Partners will be assigned randomly on the day.",
    location: "Braidhurst High School Sports Hall, Motherwell",
    ...
    <main className="min-h-screen">
      ...
      <nav className="bg-[#0C447C] px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link href="/competitions" className="text-white text-sm font-medium border-b border-white pb-0.5">Competitions</Link>
              ...
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                ...
                <div className="flex flex-col items-start md:items-end gap-3">
                  ...
                  {comp.status === "OPEN" ? (
                    ...
                    <button
                      disabled
                      className="bg-gray-100 text-gray-400 px-6 py-2 rounded-lg text-sm font-medium cursor-not-allowed"
                    >
